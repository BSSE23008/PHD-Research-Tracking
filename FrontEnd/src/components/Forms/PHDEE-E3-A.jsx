// src/components/Forms/PHDEE-E3-A.jsx
// PHD THesis Evaluation FOrm

import React, { useState, useEffect } from 'react';
import './logo.css';

const PHDEE_E3_A = ({ user, onClose, onSubmissionComplete }) => {
  ...
  // Prefill student data from user prop
  useEffect(() => {
    if (user) {
      setFormData(prev => ({
        ...prev,
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white relative">
      ...
      <div className="relative text-center mb-6">
        ...
        <h2 className="text-base font-bold">PHD THESIS EVALUATION FORM</h2>
      </div>
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            <label className="block mb-2 font-semibold">Student roll number</label>
            <input
              type="text"
      ...
      <div className="mb-8">
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="flex justify-between text-xs max-w-md mx-auto mt-1">
      ...
      <div className="mb-8">
        ...
        <div className="space-y-3">
          {[
            ...
            "The thesis does not merit the award of the degree in its current form and should undergo minor revision and the proposed changes are required to be confirmed by the supervisor only.",
            "The thesis is acceptable in its current form and can be sent to external evaluators for review."
          ].map((option, index) => (
      ...
      <div className="mb-6 border-t-2 border-black pt-4">
        ...
        <div className="mb-4">
          <label className="block mb-2 font-semibold">Remarks (if any):</label>
          <textarea
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          <div className="border border-black p-4">
            <label className="block mb-2 font-semibold">Secretary DPRC (Signature)</label>
            <input
              type="text"
          ...
          <div className="border border-black p-4">
            <label className="block mb-2 font-semibold">Recommended By</label>
            <div className="mt-2">
      ...
      <div className="text-right text-sm mt-4">
        <strong>PHDEE-E3-A Form</strong>
      </div>
    </div>
  );
};

export default PHDEE_E3_A;