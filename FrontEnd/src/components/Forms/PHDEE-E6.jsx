// FrontEnd/src/components/Forms/PHDEE-E6.jsx
// PHD THESIS DEFENSE EVALUATION FORM (PUBLIC) 
...
const PHDEE_E6 = ({ user, onClose, onSubmissionComplete }) => {
  const [formData, setFormData] = useState({
    ...
    committeeMembers: [
      ...
      { role: 'Local Evaluator 1', recommendation: '', signature: '' },
      { role: 'Local Evaluator 2', recommendation: '', signature: '' }
    ],
    remarks: '',
  ...
  if (showSuccess) {
    return (
      <div className="flex flex-col items-center justify-center p-10">
        ...
        <p className="text-lg">Public Defense Evaluation has been submitted.</p>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white relative">
      ...
      <div className="relative text-center mb-6">
        ...
        <h2 className="text-base font-bold">PHD THESIS DEFENSE EVALUATION FORM (PUBLIC)</h2>
      </div>
      ...
      <div className="mb-6 border-t-2 border-black pt-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <label className="block mb-1">Chairperson EE (Signature & Date)</label>
            <input
              type="text"
      ...
      <div className="text-right text-sm mt-4">
        <strong>PHDEE-E6 Form</strong>
      </div>
    </div>
  );
};

export default PHDEE_E6;