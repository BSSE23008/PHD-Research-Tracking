...
const PHDEE04A = ({ user, onClose, onSubmissionComplete }) => {
  ...
  useEffect(() => {
    if (user) {
      setFormData(prev => ({
        ...
        specializationField: user.research_area || prev.research_area || '',
      }));
    }
  }, [user]);
  ...
  if (showSuccess) {
    return (
      <div className="flex flex-col items-center justify-center p-10">
        ...
        <p className="text-lg">Your Synopsis Defence Request has been submitted for review.</p>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white relative">
      ...
      <div className="relative text-center mb-6">
        ...
        <h2 className="text-base font-bold">SYNOPSIS DEFENCE REQUEST FORM</h2>
      </div>
      ...
      <div className="mb-6">
        ...
        <div className="mb-4">
          <label className="inline-block w-64">Expected date for Proposal Examination:</label>
          <input
            type="text"
      ...
      <div className="mb-6">
        ...
        <div className="mb-2">
          ...
          <span>I am aware of the HEC Plagiarism Policy</span>
        </div>
        <div className="mb-2">
        ...
        <div className="mb-2">
          ...
          <span>I have passed Comprehensive Examination Successfully (Major and Minor)</span>
        </div>
        <div className="mb-4">
          <span className="inline-block w-6">5.</span>
          <span>I have shared a copy of Proposal draft with all GEC Members to seek input on proposal</span>
        </div>
      ...
      <div className="text-right text-sm mt-4">
        <strong>PHDEE04-A Form</strong>
      </div>
    </div>
  );
};

export default PHDEE04A;